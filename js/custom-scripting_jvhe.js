...
$('#artikelen').append($("<li></li>").html('<h3>' +
        artikel.deartnr + '</h3><br/>' +
        'ID: ' + artikel.deartom + '<br/>'));

	
//    $('#result').append('<li class="artikel"><a href="artikel.html?deartnr=' + artikel.deartnr + '"> <img class="myListLogo" src="./img/nikon_coolpix-l25-white_8880867_1.jpg"> <h1 class="myHeader">' +  artikel.deartom + '</h1><p class="myParagraph">'+artikel.deakppr+'</p></a></li>');
